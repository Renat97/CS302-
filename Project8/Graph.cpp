...
/// construct's graph from the text file, "Dijkstra"
...
/// The basis initializer for all constructors
...
///Maps a unique id to the given vertex
...
/// enqueue for a certain NodeQueue in Graph
...
/// Depth First traversal, traverse's without checking all neighbors on same level
...
/// Checks all the neighbors on the same level
